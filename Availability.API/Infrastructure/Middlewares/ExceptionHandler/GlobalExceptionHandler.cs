namespace Availability.API.Infrastructure.Middlewares.ExceptionHandler
{
    ...
    public class GlobalExceptionHandler {
        ...
        private static readonly ReadOnlyDictionary<int, HttpStatusCode> CodeToStatusCodeMap = new ReadOnlyDictionary<int, HttpStatusCode>(new Dictionary<int, HttpStatusCode>() {
            [AvailabilityException.INVALID_DATA] = HttpStatusCode.BadRequest,
            [AvailabilityException.NOT_FOUND] = HttpStatusCode.NotFound,
            [AvailabilityException.SERVER_ERROR] = HttpStatusCode.InternalServerError
        });
